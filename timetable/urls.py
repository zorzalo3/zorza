...
urlpatterns = [
    ...
    path('api/1/bell/', never_cache(timetable_bell_api), name='timetable_bell_api'),
    path('api/1/last_update/', never_cache(get_last_update_api), name='timetable_last_update_api'),
    ...
    path('matches/add/', AddMatchView.as_view(), name='add_match'),
    path('matches/', show_matches, name='matches'),
